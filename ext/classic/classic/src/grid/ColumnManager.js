...
Ext.define('Ext.grid.ColumnManager', {
    ...
    /**
     * If called from a root header, returns the index of a leaf level header regardless of what
     * the nesting structure is.
     *
     * If called from a group header, returns the index of a leaf level header relative
     * to the group header.
     *
    ...
    /**
     * If called from a root header, gets a leaf level header by index regardless of what
     * the nesting structure is.
     *
     * If called from a group header, returns the index of a leaf level header relative
     * to the group header.
